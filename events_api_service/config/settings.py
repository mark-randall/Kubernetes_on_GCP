"""
Django settings for events_api_service project.
...
if not all (k in os.environ.keys() for k in set(mandatory_settings)):
    from . import secrets_manager_util
    try:
        secrets = secrets_manager_util.access_secrets(mandatory_settings + optional_settings)
...
SECRET_KEY = '2eze21y5c(!1w6%!0du^39amfgx8#cmpt^4bfejak88@gpe2w-'
